<template>
 ...
 <link href="https://fonts.googleapis.com/css2?family=Lato&display=swap" rel="stylesheet">
  ...
  <body>
    ...
    <div class="wrapper">
      <ul>
<li> <router-link class='router' to="/">Дом </router-link></li>
<li> <router-link class='router' to="chat">Чат </router-link></li>
<li> <router-link class='router' to="test">API</router-link></li>
